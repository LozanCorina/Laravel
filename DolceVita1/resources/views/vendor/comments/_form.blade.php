        ...
        <form method="POST" action="{{ route('comments.store') }}">
            ...
            @if(isset($guest_commenting) and $guest_commenting == true)
                <div class="form-group">
                    <label for="message">Introdu Numele</label>
                ...
                <div class="form-group">
                    <label for="message">Introdu adresa de Email</label>
            ...
            <div class="form-group">
                <label for="message">Introdu mesajul</label>
            ...
            <button type="submit" class="btn btn-primary btn-block" style="width: 200px;">Adaugă</button>
            <small class="text-muted">Dupa ce apăsați "Adaugă" sunteți de acord cu <br> Termenii și politica noastră.</small>  
        </form>
    </div>
</div>
<br />